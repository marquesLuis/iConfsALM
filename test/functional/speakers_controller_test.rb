...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { keynote: @speaker.keynote, person_id: @speaker.person_id, session_id: @speaker.session_id }
    end
  ...
  test "should update speaker" do
    put :update, id: @speaker, speaker: { keynote: @speaker.keynote, person_id: @speaker.person_id, session_id: @speaker.session_id }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
